    ...
    () => [
      ...
      },
      {
        ...
        render: (value: unknown) => {
          ...
          if (!description) return <span className="text-gray-400">無</span>;
          return (
            <Tooltip content={description}>
              <span className="text-sm text-gray-600 dark:text-gray-400 cursor-help line-clamp-2">{description}</span>
            </Tooltip>
          );
        },
      },
