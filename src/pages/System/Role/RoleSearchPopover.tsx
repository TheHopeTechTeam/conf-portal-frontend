  ...
  return (
    <div className="relative inline-block">
      ...
      {isOpen && (
        ...
        >
          <div className="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-200">{popover.title || "搜尋角色"}</div>
          <div className="space-y-3">
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-300">關鍵字</label>
              <input
