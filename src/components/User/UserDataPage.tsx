...
import { MdCheck, MdClose, MdDelete, MdEdit, MdVisibility } from "react-icons/md";
...
export default function UserDataPage() {
  ...
  const rowActions: DataTableRowAction<UserDetail>[] = useMemo(
    ...
    [openModal, openDeleteModal, openViewModal]
  );
  ...
  return (
    <>
      ...
      <Modal isOpen={isDeleteOpen} onClose={closeDeleteModal} className="max-w-[560px] w-full mx-4 p-6">
        <h3 className="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">確認刪除用戶</h3>
        <UserDeleteForm onSubmit={handleDelete} onCancel={closeDeleteModal} submitting={submitting} />
      </Modal>
