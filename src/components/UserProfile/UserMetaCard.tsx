...
export default function UserMetaCard() {
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 flex items-center justify-center">
              <MdAccountCircle size={80} className="text-gray-500 dark:text-gray-400" />
            </div>
      ...
      <Modal title="Edit Personal Information" isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4">
